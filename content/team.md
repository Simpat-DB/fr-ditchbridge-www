...
<img src="{site.url.resolve('/images/photo_SPA.jpg')}" alt="Simon_Patard" style="width:160px;height:160px;object-fit:cover;border-radius:50%;">
...
<img src="{site.url.resolve('/images/Charles_Sabourdin.jpg')}" alt="Charles_Sabourdin" style="width:160px;height:160px;object-fit:cover;border-radius:50%;">
